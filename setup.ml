...
(* OASIS_START *)
(* DO NOT EDIT (digest: 113728a002536c091bc382c798ec45fd) *)
(*
     ...
     package =
       {
          ...
          homepage = Some "http://forge.ocamlcore.org/projects/odepack/";
            ...
            [
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tests/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "odepack"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "lsoda.ml"; });
               Executable
                 ({
                     cs_name = "closure";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "closure.ml"; });
               Doc
                 ({
                     cs_name = "API";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Odepack";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Svn;
                      src_repo_location =
                        "svn://scm.ocamlcore.org/svn/odepack/trunk";
                      src_repo_browser =
                        Some
                          "https://forge.ocamlcore.org/scm/browser.php?group_id=191";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "minimal.ml"; });
               Executable
                 ({
                     cs_name = "pendulum";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "pendulum.ml"; })
            ];
          plugins =
